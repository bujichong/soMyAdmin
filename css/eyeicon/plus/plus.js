...
'<div class="searchhead soform">'+
	...
	'<div class="item-one">'+
		...
		'<label class="lab-val"><input class="rad rad-size" type="radio" value="16px" name="iconsize" />16px</label>'+
		'<label class="lab-val"><input class="rad rad-size" type="radio" value="20px" name="iconsize" checked="checked" />20px</label>'+
